...
module.exports = function GrottoOfLostSoulsGuide(d) {
		...
		if (!hooks.length) {
			...
			function sActionStage(event) {
				...
				if (whichboss==3 && ThirdBossActions[skillid]) {
					...
					notice2(powerMsg + ThirdBossActions[skillid].msg)
				}
			}
    ...
    d.toClient('S_DUNGEON_EVENT_MESSAGE', 2, {
      type: 42,
      chat: 0,
      channel: 0,
      message: msg
